...
<?php
			  $s1="SELECT `id`, `Name`, `Image`, `Link`, `Status` FROM `list` where Status=1";
...
<div class="bee-block bee-block-1 bee-image"><img alt="chocolate" class="bee-center bee-autowidth" src="<?php echo $img; ?>" style="max-width:366px;"></div>
<div class="bee-block bee-block-2 bee-heading">
<h3 style="color:#432b27;direction:ltr;font-family:'Abril Fatface', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:28px;font-weight:400;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;"><span class="tinyMce-placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $id; ?><?php echo $name; ?></font></font></span> </h3>
</div>
<div class="bee-block bee-block-3 bee-text">
<div class="bee-text-content" style="font-size: 14px; line-height: 150%; color: #222; font-family: inherit;">
<p style="font-size: 14px; line-height: 21px; text-align: center;"><span style="font-size: 26px; line-height: 39px;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"></font></font></span></p>
<a class="bee-button-content" href="<?php echo $url; ?>" style="font-size: 16px; background-color: #f9bdb5; border-bottom: 0px solid #F9BDB5; border-left: 0px solid #F9BDB5; border-radius: 0px; border-right: 0px solid #F9BDB5; border-top: 0px solid #F9BDB5; color: #432b27; font-family: inherit; font-weight: 400; max-width: 100%; padding-bottom: 10px; padding-left: 30px; padding-right: 30px; padding-top: 10px; width: auto; direction: ltr; display: inline-block;"><span style="word-break: break-word; font-size: 16px; line-height: 200%;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Click</font></font></span></a>

<button onclick="" class="confirm bee-button-content"  style="font-size: 16px; background-color: #f9bdb5; border-bottom: 0px solid #F9BDB5; border-left: 0px solid #F9BDB5; border-radius: 0px; border-right: 0px solid #F9BDB5; border-top: 0px solid #F9BDB5; color: #432b27; font-family: inherit; font-weight: 400; max-width: 100%; padding-bottom: 10px; padding-left: 30px; padding-right: 30px; padding-top: 10px; width: auto; direction: ltr; display: inline-block;"><span style="word-break: break-word; font-size: 16px; line-height: 200%;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Confirmed</font></font></span></button>
...
$(document).on("click", ".confirm", function (e) {
	var id=$(this).data("id");
	var response = confirm("Are you sure you want to delete the data?"); 
	if (response == true)
	{
		alert("Confirmed mm!!");
		$.ajax({
